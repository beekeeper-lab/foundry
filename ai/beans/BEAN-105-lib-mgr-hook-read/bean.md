...
- [x] Tree shows all existing hooks when the Hook category is selected
- [x] Clicking a hook file displays its content in the editor pane
- [x] File path label updates to show the selected file path
- [x] Live preview renders the hook markdown correctly
...
|---|------|-------|------------|--------|
| 1 | Verify hook read logic and add dedicated tests | developer | — | Done |
...
> Duration backfilled from git timestamps (commit→merge, 170s).
