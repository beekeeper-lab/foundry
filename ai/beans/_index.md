...
| BEAN-251 | Clarify Agent Permission Scope in Generated Projects | App | Medium | Done | team-lead |
...
| BEAN-286 | Wizard Surfaces Validation Findings Inline (Persona + Hook Safety Pages) | App | High | Unapproved | (unassigned) |
| BEAN-287 | Generation Failure Recovery — Sticky Banner + Auto-Scroll | App | Medium | Unapproved | (unassigned) |
| BEAN-288 | Sidebar Navigation Preserves and Surfaces In-Progress Wizard State | App | Medium | Unapproved | (unassigned) |
