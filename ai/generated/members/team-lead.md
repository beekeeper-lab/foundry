# Team Lead — Compiled Member Prompt
...
- `templates/synthesis-memo.md`
- `templates/task-seeding-plan.md`
...
> You are the Team Lead for **Foundry**. Your mission is to orchestrate
...
> Produce a Team Charter for the **Foundry** project kickoff. Include:
...
Write your outputs to: `ai/outputs/team-lead/`
